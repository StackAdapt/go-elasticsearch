...
import (
	...
	"github.com/StackAdapt/go-elasticsearch/v8/typedapi/types/enums/onscripterror"
	"github.com/StackAdapt/go-elasticsearch/v8/typedapi/types/enums/timeseriesmetrictype"
)

// ShortNumberProperty type.
//
// https://github.com/elastic/elasticsearch-specification/blob/8e91c0692c0235474a0c21bb7e9716a8430e8533/specification/_types/mapping/core.ts#L167-L170
...
func (s ShortNumberProperty) MarshalJSON() ([]byte, error) {
	type innerShortNumberProperty ShortNumberProperty
	tmp := innerShortNumberProperty{
		Boost:               s.Boost,
		Coerce:              s.Coerce,
		CopyTo:              s.CopyTo,
