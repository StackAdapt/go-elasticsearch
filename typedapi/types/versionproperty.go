...
//
// https://github.com/elastic/elasticsearch-specification/blob/8e91c0692c0235474a0c21bb7e9716a8430e8533/specification/_types/mapping/core.ts#L287-L289
...
func (s VersionProperty) MarshalJSON() ([]byte, error) {
	type innerVersionProperty VersionProperty
	tmp := innerVersionProperty{
		CopyTo:      s.CopyTo,
