...
import (
	...
	"github.com/StackAdapt/go-elasticsearch/v8/typedapi/types/enums/gappolicy"
)

// LinearMovingAverageAggregation type.
//
// https://github.com/elastic/elasticsearch-specification/blob/8e91c0692c0235474a0c21bb7e9716a8430e8533/specification/_types/aggregations/pipeline.ts#L242-L245
...
func (s LinearMovingAverageAggregation) MarshalJSON() ([]byte, error) {
	type innerLinearMovingAverageAggregation LinearMovingAverageAggregation
	tmp := innerLinearMovingAverageAggregation{
