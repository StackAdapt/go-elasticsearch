...
//
// https://github.com/elastic/elasticsearch-specification/blob/8e91c0692c0235474a0c21bb7e9716a8430e8533/specification/_types/mapping/specialized.ts#L60-L63
...
func (s HistogramProperty) MarshalJSON() ([]byte, error) {
	type innerHistogramProperty HistogramProperty
	tmp := innerHistogramProperty{
		Dynamic:         s.Dynamic,
		Fields:          s.Fields,
