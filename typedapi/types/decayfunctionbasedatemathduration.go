...
// DecayFunctionBaseDateMathDuration type.
//
...
type DecayFunctionBaseDateMathDuration struct {
...
func (s DecayFunctionBaseDateMathDuration) MarshalJSON() ([]byte, error) {
	type opt DecayFunctionBaseDateMathDuration
...
// NewDecayFunctionBaseDateMathDuration returns a DecayFunctionBaseDateMathDuration.
func NewDecayFunctionBaseDateMathDuration() *DecayFunctionBaseDateMathDuration {
	r := &DecayFunctionBaseDateMathDuration{
