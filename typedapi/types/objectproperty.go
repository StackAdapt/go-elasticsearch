...
// ObjectProperty type.
//
// https://github.com/elastic/elasticsearch-specification/blob/8e91c0692c0235474a0c21bb7e9716a8430e8533/specification/_types/mapping/complex.ts#L46-L50
...
func (s ObjectProperty) MarshalJSON() ([]byte, error) {
	type innerObjectProperty ObjectProperty
	tmp := innerObjectProperty{
		CopyTo:      s.CopyTo,
		Dynamic:     s.Dynamic,
		Enabled:     s.Enabled,
		Fields:      s.Fields,
