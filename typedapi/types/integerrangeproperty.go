...
//
// https://github.com/elastic/elasticsearch-specification/blob/8e91c0692c0235474a0c21bb7e9716a8430e8533/specification/_types/mapping/range.ts#L42-L44
...
func (s IntegerRangeProperty) MarshalJSON() ([]byte, error) {
	type innerIntegerRangeProperty IntegerRangeProperty
	tmp := innerIntegerRangeProperty{
		Boost:       s.Boost,
		Coerce:      s.Coerce,
		CopyTo:      s.CopyTo,
