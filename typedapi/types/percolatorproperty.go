...
//
// https://github.com/elastic/elasticsearch-specification/blob/8e91c0692c0235474a0c21bb7e9716a8430e8533/specification/_types/mapping/core.ts#L188-L190
...
func (s PercolatorProperty) MarshalJSON() ([]byte, error) {
	type innerPercolatorProperty PercolatorProperty
	tmp := innerPercolatorProperty{
		Dynamic:     s.Dynamic,
		Fields:      s.Fields,
